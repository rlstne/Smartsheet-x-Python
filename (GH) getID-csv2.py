...
try:
    ...
    if selection == 1:
        ...
        print("")
        get1 = datetime.now()
        print(get1.strftime("%Y-%m-%d %H:%M:%S"), "Generating Sheets IDs 1")
    elif selection == 2:
        wdid = 'id 2'
        print("")
        get2 = datetime.now()
        print(get2.strftime("%Y-%m-%d %H:%M:%S"), "Generating Sheets IDs 2")
    elif selection == 3:
        wdid = 'id 3'
        print("")
        get3 = datetime.now()
        print(get3.strftime("%Y-%m-%d %H:%M:%S"), "Generating Sheets IDs 3")
    else:
